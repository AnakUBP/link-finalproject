    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card service-card">
                <img src="FOTO/CBR.jpg" class="card-img-top" alt="Bike Rental">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="FOTO/R6.jpg" class="card-img-top" alt="Bike Rental">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="R1_.jpg" class="card-img-top" alt="Bike Rental">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="FOTO/v4s.jpg" class="card-img-top" alt="Bike Rental">
                <div class="card-body">
