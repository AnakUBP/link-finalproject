...
<div class="container my-5">
    ...
    <div class="card mb-4">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="<?php echo $detail['mobil_foto']; ?>" class="img-fluid rounded-start" alt="Foto Mobil">
            </div>
            <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="card-footer text-center">
            <?php if (!empty($detail['bukti_pembayaran'])): ?>
                ...
                <img src="uploads/<?php echo $detail['bukti_pembayaran']; ?>" class="img-fluid" alt="Bukti Pembayaran" style="max-height: 300px;">
            <?php else: ?>
            ...
            <?php if (!empty($detail['nama_supir'])): ?>
                ...
                <img src="uploads/<?php echo $detail['foto_supir']; ?>" class="img-fluid" alt="Foto Supir" style="max-height: 150px;">
            <?php else: ?>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($detail['bukti_pembayaran'])): ?>
                                <a href="uploads/<?php echo $detail['bukti_pembayaran']; ?>" target="_blank">Lihat Bukti</a>
                            <?php else: ?>
                                Tidak Ada
                            <?php endif; ?>
                        </td>
